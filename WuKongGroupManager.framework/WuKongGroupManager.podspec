Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/WuKongIM/WuKongGroupManager-Framework.git",:tag => "#{s.version}" }
  s.requires_arc = true
  s.ios.deployment_target    = '11.0'
  s.platform     = :ios, '11.0'
  s.resource             = 'ios/WuKongIMSDK.WuKongGroupManager/WuKongIMSDK.bundle'
   s.vendored_frameworks  = 'ios/WuKongGroupManager.framework'
  s.xcconfig = {
    'OTHER_LDFLAGS' => '-ObjC',
    "LIBRARY_SEARCH_PATHS"=>"${PODS_ROOT}/../../WuKongGroupManager-Framework/ios/lib",
